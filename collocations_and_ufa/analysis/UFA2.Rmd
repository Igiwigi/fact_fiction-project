...
```
#this is kind of clumsy naming, can fix it later
#also some redundant variables etc
```{r}
#3 word windows, old
results <- process_collocate_folder(
  folder_path = "../ccollocate_results_1665-1958_fact_500-3_w3",
  mi_score_threshold = 3,
...
results <- process_collocate_folder(
  folder_path = "../collocate_results_1665-1958_facts_500-5_w3",
  mi_score_threshold = 3,
  highlight_word = "fiction",
  output_dir = "collocate_results/3window"
)
...
#5 word windows, old
results <- process_collocate_folder(
  folder_path = "../collocate_results_1665-1958_fact_500-5_w5",
  mi_score_threshold = 3,
  highlight_word = "fiction",
...
results <- process_collocate_folder(
  folder_path = "../collocate_results_1665-1958_facts_500-5_w5",
  mi_score_threshold = 3,
  highlight_word = "fiction",
  output_dir = "collocate_results/5window"
)
