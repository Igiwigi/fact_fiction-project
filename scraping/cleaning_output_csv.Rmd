...
combined_run_now <- read.csv("combined_run2.1.csv")
file_list <- list.files(pattern = "royalsociety2.*\\.csv")
...
write.csv(final_combined_df, "2nd_run_combined.csv", row.names = FALSE)
