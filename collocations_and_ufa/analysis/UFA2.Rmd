...
#add a way to see all the collocates that made it in (3>=MI) for each year so i can read the contexts
...
results <- process_collocate_folder(
  folder_path = "../collocation_results/FACTS/collocate_results_1665-1958_FACTS_css1_w3/collocation_txt",
  output_dir = "collocate_results/3window"
)
...
results <- process_collocate_folder(
  folder_path = "../collocation_results/FACTS/collocate_results_1665-1958_FACTS_css1_w5/collocation_txt",
  output_dir = "collocate_results/5window"
)
```
...
#a way to see all the collocates that made it in (3>=MI) for each year so i can read the contexts
#maybe make a script that updates the contexts for each year and word (to omit the contexts the words of which didnt make it)(might also be smarter to do the filtering early)
