...
---
#add collocate window size to the UFA plot and clean the code so its not total dogwater
...
```{r set_frequency_treshold_files}
#3 word windows
results <- process_collocate_folder(
  folder_path = "../fact_results/collocate_results_1665-1958_fact_500-3_w3/collocation_txt",
  output_dir = "collocate_results/old/3window"
)

results <- process_collocate_folder(
  folder_path = "../facts_results/collocate_results_1665-1958_facts_500-5_w3/collocation_txt",
  output_dir = "collocate_results/old/3window"
)

#5 word windows
results <- process_collocate_folder(
  folder_path = "../fact_results/collocate_results_1665-1958_fact_500-5_w5/collocation_txt",
  output_dir = "collocate_results/old/5window"
)

results <- process_collocate_folder(
  folder_path = "../facts_results/collocate_results_1665-1958_facts_500-5_w5/collocation_txt",
  output_dir = "collocate_results/old/5window"
)
```
...
#3 word windows
results <- process_collocate_folder(
  folder_path = "../fact_results/collocate_results_1665-1958_FACT_css_w3/collocation_txt",
  output_dir = "collocate_results/3window"
)

results <- process_collocate_folder(
  folder_path = "../facts_results/collocate_results_1665-1958_FACTS_css_w3/collocation_txt",
  output_dir = "collocate_results/3window"
)

#5 word windows
results <- process_collocate_folder(
  folder_path = "../fact_results/collocate_results_1665-1958_FACT_css_w5/collocation_txt",
  output_dir = "collocate_results/5window"
)

results <- process_collocate_folder(
  folder_path = "../facts_results/collocate_results_1665-1958_FACTS_css_w5/collocation_txt",
  output_dir = "collocate_results/5window"
)
```
